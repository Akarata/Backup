...
CMD_HELP.update(
    ...
    \n\n✅** CMD ➥** `.flip`\
    \n**Fungsi   ➥  **Membalikan stiker\
    \n\n✅** CMD ➥** `.gray`\
    \n**Fungsi   ➥  **Menjadikan file media Anda hitam putih\
    \n\n✅** CMD ➥** `.zoom` atau `.zoom range`\
    \n**Fungsi   ➥  **Memperbesar file media Anda\
    \n\n✅** CMD ➥** `.frame` atau `.frame range` or `.frame range ; fill`\
    \n**Fungsi   ➥  **Buat bingkai untuk file media Anda\
    \n**Fill:** Ini menentukan nilai isian piksel atau nilai warna yang akan diterapkan. Nilai defaultnya adalah 0 yang artinya warnanya hitam.\
    "
    }
)
