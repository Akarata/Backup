...
CMD_HELP.update(
    {
        ...
        \n**Fungsi   ➥  **Will google  search and sends you top 10 results links.\
        \n\n✅** CMD ➥** `.grs` reply to image\
        \n**Fungsi   ➥  **Will google reverse search the image and shows you the result.\
        \n\n✅** CMD ➥** `.reverse`\
        \n**Fungsi  ➥  **Reply to a pic/sticker to revers-search it on Google Images !!"
    }
)
