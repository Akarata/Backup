...
if Config.PRIVATE_GROUP_ID is not None:
    ...
    if PMMENU:
        ...
        async def on_new_private_message(event):
            ...
            USER_BOT_NO_WARN = (
                f"[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](tg://user?id={chat_id})\n\n"
                f"Tuan saya {mention} belum menyetujui Anda. Jangan mengirim spam ke kotak masuknya"
                "Tinggalkan nama, alasan, dan 10rb $ dan semoga Anda akan mendapat balasan dalam 2 tahun cahaya.\n\n"
